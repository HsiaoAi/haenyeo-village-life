...
const CLOCK_RATE=7;    // in-game minutes per real second — the day flows on its own (slower, ~3.4 min/day)
...
function startEat(){
  ...
  scene='eating'; eatT=0;
  P.x=392; P.y=424; P.face=1; P.moving=false;   // sit cross-legged on the LEFT (red) cushion, bowl on the table above
  $('prompt').classList.remove('show');
  tone(300,.25,'sine',.04);
}
