...
function drawBeachCompanions(t){
  ...
  if(tm>=1200){                       // 20:00 — hold hands and head home, then gone
    const p=Math.min(1,(tm-1200)/60), off=-p*360, al=p>0.82?Math.max(0,(1-p)/0.18):1;
  ...
  } else if(tm>=1080&&tm<1200){       // 18–20 drive-in beach movie (umbrella/towel/bench cleared above)
